package com.payano.homeassistant.HomeAssistant;

import com.payano.homeassistant.HomeAssistant.HAConnection.ConnectionHandler;
import com.payano.homeassistant.HomeAssistant.HAConnection.HAConnectionEvent;
import com.payano.homeassistant.HomeAssistant.HAConnection.HAConnectionSubscriber;
...
public class HomeAssistant implements HAConnectionSubscriber, Runnable {
    private static HomeAssistant ourInstance = new HomeAssistant();
    ...
    public static HomeAssistant getInstance() {
        return ourInstance;
    }
